        ...
        "/manual-entries": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by entry type (computershare, morgan_stanley, real_estate, etc.)",
                        "name": "type",
                        "in": "query"
                    }
                ],
        ...
        "/manual-entries/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Entry type (computershare, morgan_stanley, real_estate, cash_holdings, crypto_holdings)",
                        "name": "type",
                        "in": "query",
                        "required": true
                    }
